...
MASK_WEIGHT_URL = "efficientvit/assets/checkpoints/sam/mask_decoder_clothes.pt"
TRAINED_WEIGHT_URL = "efficientvit/assets/checkpoints/sam/trained_model_clothes.pt"
...
KEEP_CATEGORIES = [4, 5, 6, 7, 8, 17]  # clothes and scarf
...
def main() -> None:
    ...
    trainer = L.Trainer(
        ...
        default_root_dir="./models/sam_clothes",
    )
